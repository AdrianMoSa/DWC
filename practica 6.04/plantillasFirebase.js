...
const pintarProducto = (documento) => {
  ...
  <input type="button" class= "alistar" value="Añadir a lista" id="${documento.id}">
...
const pintarProductoLista = (documento) => {
  var contador=0;
...
export{pintarProducto,borrar,pintarProductoLista};